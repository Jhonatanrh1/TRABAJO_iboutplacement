...
if (form_mail("omar.sanchez201999@gmail.com", $_POST[asunto], "Los datos introducidos en el formulario son:\n\n", $_POST[email])) echo "Su formulario ha sido enviado con exito"; 
echo "<script>alert('Mensaje enviado, redireccionando a página principal.')</script>"; 
echo "<script>location.href='http://iboutplacement.com/Formulario_online/index.html'</script>"; 
?>
